...
SELECT TRIP_DISTANCE, TOTAL_AMOUNT, TOTAL_AMOUNT / TRIP_DISTANCE AS "Cost Per Mile"
FROM TAXI_TBL
ORDER BY "Cost Per Mile" DESC
LIMIT 100;
...
DELETE FROM HIGH_VOLUME_TBL --TAXI_TBL
WHERE (PU_LOCATIONID IN (264, 265) AND DO_LOCATIONID IN (264, 265)) OR DO_LOCATIONID IN (264, 265);
