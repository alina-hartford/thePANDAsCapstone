...
SELECT PU_DATETIME, DO_DATETIME, FARE_AMOUNT, TRIP_DISTANCE, YEAR, MONTH, DAY, IS_WEEKEND, PU_LOCATIONID, TZ.ZONE AS PU_ZONE, TZ.BOROUGH AS PU_BOROUGH, 
DO_LOCATIONID, TZ2.ZONE AS DO_ZONE, TZ2.BOROUGH AS DO_BOROUGH
...
SELECT L.COMPANY_NAME AS COMPANY_NAME, PU_DATETIME, DO_DATETIME, FARE_AMOUNT, 
TRIP_DISTANCE, YEAR, MONTH, DAY, IS_WEEKEND, PU_LOCATIONID, TZ.ZONE AS PU_ZONE, TZ.BOROUGH AS PU_BOROUGH, 
DO_LOCATIONID, TZ2.ZONE AS DO_ZONE, TZ2.BOROUGH AS DO_BOROUGH
...
-- Landmarks View for Data Visualization
